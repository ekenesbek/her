...
export const STRINGS = {
  ...
  "chat.chrome.auto": { en: "auto", ru: "auto" },
  "chat.chrome.notLinked": { en: "not linked", ru: "не подключён" },
  "chat.logout": { en: "log out", ru: "выйти" },
  "chat.threads": { en: "Chats", ru: "Чаты" },
  "chat.new": { en: "new chat", ru: "новый чат" },
  "chat.untitled": { en: "New chat", ru: "Новый чат" },
  "chat.msgs": { en: "messages · today", ru: "сообщений · сегодня" },
  "chat.msg": { en: "message · today", ru: "сообщение · сегодня" },
  "chat.msgs.short": { en: "messages", ru: "сообщений" },
  "chat.msg.short": { en: "message", ru: "сообщение" },
